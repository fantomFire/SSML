...
public class CustomDatePicker {
    ...
    private ScrollPickerView year_pv, month_pv, day_pv, hour_pv, minute_pv;
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            datePickerDialog = new Dialog(context, R.style.date_picker);
    ...
    private void initView() {
        year_pv = (ScrollPickerView) datePickerDialog.findViewById(R.id.year_pv);
        month_pv = (ScrollPickerView) datePickerDialog.findViewById(R.id.month_pv);
        day_pv = (ScrollPickerView) datePickerDialog.findViewById(R.id.day_pv);
        hour_pv = (ScrollPickerView) datePickerDialog.findViewById(R.id.hour_pv);
        minute_pv = (ScrollPickerView) datePickerDialog.findViewById(R.id.minute_pv);
    ...
    private void addListener() {
        year_pv.setOnSelectListener(new ScrollPickerView.onSelectListener() {
            @Override
        ...
        month_pv.setOnSelectListener(new ScrollPickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        day_pv.setOnSelectListener(new ScrollPickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        hour_pv.setOnSelectListener(new ScrollPickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        minute_pv.setOnSelectListener(new ScrollPickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {

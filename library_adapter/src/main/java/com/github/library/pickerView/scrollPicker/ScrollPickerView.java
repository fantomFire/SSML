...
/**
 * Created by 苏坡坡要吃婆婆酥 on 2018 2018/3/1 .
 * 上下滑动的选择器
 */
...
public class ScrollPickerView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.date_text_select));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        nPaint.setColor(ContextCompat.getColor(context, R.color.date_text));
    }

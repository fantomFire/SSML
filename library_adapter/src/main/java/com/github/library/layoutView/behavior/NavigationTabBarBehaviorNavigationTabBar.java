...
import com.github.library.layoutView.NavigationTabBar;

//NavigationTabBarBehavior搭配CoordinatorLayout时候使用，滑动隐藏效果
public class NavigationTabBarBehaviorNavigationTabBar extends NavigationTabBarVerticalScrollingBehavior<NavigationTabBar> {
    ...
    public NavigationTabBarBehaviorNavigationTabBar(final boolean behaviorTranslationEnabled) {
        super();
...
// This method is intentionally empty, because of override
    ...
    public static NavigationTabBarBehaviorNavigationTabBar from(NavigationTabBar view) {
        ...
        if (!(behavior instanceof NavigationTabBarBehaviorNavigationTabBar))
            throw new IllegalArgumentException(
                    "The view is not associated with NavigationTabBarBehaviorNavigationTabBar");

        return (NavigationTabBarBehaviorNavigationTabBar) behavior;
    }

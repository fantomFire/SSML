...
import com.github.library.layoutView.behavior.NavigationTabBarBehaviorNavigationTabBar;
...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
    ...
    protected NavigationTabBarBehaviorNavigationTabBar mBehavior;
    ...
    public void setBehaviorEnabled(final boolean enabled) {
        ...
        if (getParent() != null && getParent() instanceof CoordinatorLayout) {
            ...
            if (mBehavior == null) mBehavior = new NavigationTabBarBehaviorNavigationTabBar(enabled);

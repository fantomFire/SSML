 ...
 *******************************************************************************/
package com.github.library.refreshView.internal;
...
import com.github.library.refreshView.ILoadingLayout;
import com.github.library.refreshView.PullToRefreshBase;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		mHeaderText.setTextColor(Color.rgb(136, 136, 136));
		...
		switch (mode) {
			case PULL_FROM_END:
				...
				// Load in labels
				mPullLabel = context.getString(R.string.pull_to_refresh_more_label);

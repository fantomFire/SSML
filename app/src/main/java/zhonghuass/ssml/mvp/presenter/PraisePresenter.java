...
public class PraisePresenter extends BasePresenter<PraiseContract.Model, PraiseContract.View> {
    ...
    @Inject
    public PraisePresenter(PraiseContract.Model model, PraiseContract.View rootView) {
    ...
    public void getPraiseData(String member_id, String member_type, int page) {
        mModel.getPraiseData(member_id,member_type,page)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse<List<ShareMeBean>>>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse<List<ShareMeBean>> listBaseResponse) {
                        if (listBaseResponse.isSuccess()) {
                            mRootView.showPraiseData(listBaseResponse.getData());
                        } else {

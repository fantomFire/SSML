...
import zhonghuass.ssml.di.component.DaggerImageLayout3Component;
...
import zhonghuass.ssml.mvp.presenter.ImageLayout3Presenter;
 ...
 * 三张图的模板
 */
public class ImageLayout3Fragment extends BaseFragment<ImageLayout3Presenter> implements ImageLayout3Contract.View, OnSingleFlingListener, ImageEditorActivity.IOnFocusListenable {
    ...
    public static ImageLayout3Fragment newInstance() {
        ImageLayout3Fragment fragment = new ImageLayout3Fragment();
        return fragment;
    }

    public static ImageLayout3Fragment newInstance(List<LocalMedia> imgList) {
        ImageLayout3Fragment fragment = new ImageLayout3Fragment();
        selectList = imgList;
        return fragment;
    }
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerImageLayout3Component //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .imageLayout3Module(new ImageLayout3Module(this))
                .build()
                .inject(this);
    }
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_image_layout3, container, false);
    }

...
public interface DialyContract {
    ...
    interface View extends IView {
        void showDailyHeaderData(DailyBean data);

        void showDailyData(List<DailyChoicenessBean> data);
    ...
    interface Model extends IModel {
        ...
        Observable<BaseResponse<List<DailyChoicenessBean>>> getDailyData(String member_id, String member_type, int page);

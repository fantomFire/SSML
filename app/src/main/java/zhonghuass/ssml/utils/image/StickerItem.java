...
public class StickerItem {
    ...
    public RectF detectRotateRect;//旋转范围

    public RectF detectDeleteRect;//删除范围
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.isDrawHelpTool) {// 绘制辅助工具线
            ...
            canvas.drawRoundRect(helpBox, 10, 10, helpBoxPaint);//draw
            // 绘制工具按钮

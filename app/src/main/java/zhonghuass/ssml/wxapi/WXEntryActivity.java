...
import zhonghuass.ssml.utils.NetUtils;
...
public class WXEntryActivity extends Activity implements IWXAPIEventHandler {
    ...
    private String  WX_APP_SECRET="6801f057b4b285c5e6a5b282bdff2a64";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mIWxAPI = WXAPIFactory.createWXAPI(WXEntryActivity.this, WX_APP_ID, true);
